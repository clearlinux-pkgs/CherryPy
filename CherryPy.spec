...
Version  : 18.5.0
Release  : 14
URL      : https://files.pythonhosted.org/packages/0d/cc/4630fdf096859635cfcb5f9d560ec17b4114b1cc8355c7cd47b65c5f80c7/CherryPy-18.5.0.tar.gz
...
%prep
%setup -q -n CherryPy-18.5.0
cd %{_builddir}/CherryPy-18.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583535796
...
cp %{_builddir}/CherryPy-18.5.0/LICENSE.md %{buildroot}/usr/share/package-licenses/CherryPy/1c32898f7d523268279046931009a11aa4ad95b6
